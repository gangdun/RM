    ...
    try {
      ...
      if (header[0] == 0x5A) {
        ...
        if (crc_ok) {
          ...
          // RCLCPP_INFO(get_logger(), "[Receive] detect_color %d!", packet.detect_color);
          // RCLCPP_INFO(get_logger(), "[Receive] reset_tracker %d!", packet.reset_tracker);
          ...
          // RCLCPP_INFO(get_logger(), "[Receive] checksum %d!", packet.checksum);
          // RCLCPP_INFO(get_logger(), "[Receive] sizeof %ld!", sizeof(packet));
