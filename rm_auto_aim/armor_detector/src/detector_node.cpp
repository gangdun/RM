  ...
  if (pnp_solver_ != nullptr) {
    ...
    for (const auto & armor : armors) {
      ...
      if (success) {
        ...
        // double dis = sqrt((tvec.at<double>(0), 2) + pow(tvec.at<double>(1), 2) + pow(tvec.at<double>(2), 2));
        // double p_angle = 0.16;
        // if(tvec.at<double>(2) < 0)
        // {
        //   //9.167325=0.16rad
        //   armor_msg.pose.position.z = -dis * sin(p_angle + asin(-tvec.at<double>(2)/dis));
        // }
        // else
        // {
        //   armor_msg.pose.position.z = -(tvec.at<double>(2)*p_angle/asin(tvec.at<double>(2)/dis))-tvec.at<double>(2);
        // }
